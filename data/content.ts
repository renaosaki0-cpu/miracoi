...
export const whyBlocks: WhyBlock[] = [
  {
    ...
    description:
      "共同代表・安永が小学生の頃からモザンビークに関心を持ち、同級生とNGOを立ち上げ、5年以上にわたって交流を続けてきました。現地の学校や村とのつながりがあり、子どもたちの名前や顔を知っています。一度きりではなく、その後も関係を築き続けることができます。",
...
export const scheduleItems: ScheduleItem[] = [
  {
    ...
    date: "9/6（日）",
    place: "マプト",
    activity: "共同代表・尾﨑・共同代表・安永が合流。訪問予定先の学校関係者との打ち合わせ",
  },
  {
    id: "d2",
    date: "9/7（月）",
  ...
  },
  {
    ...
    date: "9/10（木）",
    place: "マプト",
    activity: "現地での活動の振り返り。共同代表・尾﨑・共同代表・安永が日本へ帰国",
  },
];
