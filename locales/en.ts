...
const en: Dictionary = {
  ...
  hero: {
    ...
    ctaNote: "Support safely and easily via READYFOR",
    scroll: "Scroll",
  },
  story: {
    label: "Story",
  ...
  mission: {
    label: "Mission",
    title: "About Miracoi — High School Unit",
    description: "Introducing Miracoi's philosophy and purpose.",
    cards: [
      { label: "Mission", title: "Voices to the future", description: "Delivering children's voices in Mozambique as unforgettable experiences through Yosakoi." },
      { label: "Vision", title: "A connected, equal world", description: "Children in Mozambique, Japan, and the world learn from each other and raise their voices." },
      { label: "Value", title: "Learn and express together", description: "Not aid, but symbiosis. Not teaching, but moving, sounding, and expressing together as equals." },
    ],
  },
  projectCore: {
    label: "Why",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "When is the crowdfunding campaign?", a: "July 12, 2026 at 23:00 through September 4, 2026 at 23:00 (JST)." },
    ],
  },
  cta: {
    label: "Join Us",
    ...
    description:
      "Your support becomes travel, naruko, and children's smiles. Help us connect their voices to the future.",
    support: "Support Us",
